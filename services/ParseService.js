...
//
// export const calcJointIndex = (answers, quarterPast = 4, quarterFuture = 1, yearPast = 2023, yearFuture = 2024) => {
...
//
//
// export const mappingAnswers = (answers) => {
//     return answers.map((item) => {
//
//     })
// }
//
// export async function postAnswer(item) {
//     let response = await fetch('http://localhost:4444/answers/2023/4', {
//         method: 'POST',
//         headers: {
...
// }
//
// export const parseFile = (filename = '../docs/4 квартал 2023 год.xlsx') => {
...
//     // }
//
//     fs.writeFileSync('./target.json', JSON.stringify(answers))
//     // fs.writeFileSync('./target2.json', JSON.stringify(calcJointIndex(answers)))
// }
//
// parseFile();
//
